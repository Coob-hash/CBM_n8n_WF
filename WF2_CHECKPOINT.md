...
2. Open PowerShell in this release folder and run:
   ...
   ```powershell
   .\Wf2Checkpoint.cmd restore --execute
   ```
...
6. Repeat from step 1 for the next test. Do not rerun WF1 or Reset-CbmDemo.py.
...
```powershell
.\Wf2Checkpoint.cmd status
.\Wf2Checkpoint.cmd restore
.\Wf2Checkpoint.cmd create
```
