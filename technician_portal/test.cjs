...
async function main(){
 for(const f of ['schema.sql','schema_wf2_completion.sql','schema_release_review.sql','technician_portal/schema.sql','technician_portal/schema.sql'])await db.exec(fs.readFileSync(path.join(app,f),'utf8'));
