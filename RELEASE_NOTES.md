...
The review release is now integrated into the official application repository. Later updates add direct Phase-A processing, OpenRouter vision, the technician report portal, guarded WF3 FM actions, strict IFC-backed closure, Unlimited OCR, and the shared WF2 email/chat completion decision.
