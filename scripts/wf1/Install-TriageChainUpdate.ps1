...
$evidence=Join-Path $RepoRoot 'validation-triage-chain'
$files=@('scripts\workflows\Apply-CbmCompatibility.ps1','docs\wf1\READ-ME-TRIAGE-CHAIN.md','cbm\app\wf1_ticket_intake_and_dispatch.json',
