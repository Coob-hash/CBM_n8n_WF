...
async function main(){
 for(const file of ['schema.sql','schema_wf2_completion.sql','schema_release_review.sql','schema_wf2_strict_closure.sql','schema_wf2_strict_closure.sql'])await db.exec(fs.readFileSync(path.join(app,'../../database',file),'utf8'));
